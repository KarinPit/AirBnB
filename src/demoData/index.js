...
//         "endDate": "2024-04-12"
//       },
//       // Add more availability periods as needed
//     ],
//     "isFavorite": true,
//     "reviews": [
//       {
...
// ]
export const dummyStays = [
  // Repeat this format for each entry
  {
    _id: "10006546",
    name: "Ribeira Charming Duplex",
    type: "House",
    ...
    availabilityPeriods: [
      { startDate: "2024-04-11", endDate: "2024-04-12" },
      { startDate: "2024-04-15", endDate: "2024-04-20" } // Added an additional period for better data richness
    ],
    isFavorite: true,
    reviews: [
      {
    ...
    availabilityPeriods: [
      { startDate: "2024-04-11", endDate: "2024-04-13" },
      { startDate: "2024-04-15", endDate: "2024-04-20" } // Added an additional period for better data richness
    ],
    isFavorite: true,
    reviews: [
  ...
  // Add other entries with similar, fully-defined structures including 'availabilityPeriods'
];
