...
export function FilterStay({ isMinimize }) {
 ...
 const updateGuestCount = (type, delta) => {
  ...
  const orderToSave = { ...currentOrder, [type]: guestCounts[type] }
...
function handleDateClick(ref) {
  if (!ref.current.getAttribute('data-name')) {
  ...
  >
    ...
    <form className="search-form" onSubmit={handleSubmit}>
      <div className="input-group">
        ...
        <div className="input-container check-in-container" ref={startDate} onClick={() => {handleDateClick(startDate)}}>
          ...
          <div className="input-container check-out-container" ref={endDate} onClick={() => {handleDateClick(endDate)}}>
      ...
      {showDatePicker &&
      <div ref={datePicker} data-name="datePicker" onClick={() => {handleDateClick(datePicker)}}>
        <CalendarPicker />
      </div>
      }
      </div>
