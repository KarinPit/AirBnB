...
// // import { SOCKET_EVENT_CAR_REMOVED, socketService, SOCKET_EVENT_CAR_ADDED, SOCKET_EVENT_CAR_UPDATED } from '../services/socket.service.js'


export function StayIndex() {
    return (
        <h2>This is the Stays page</h2>
    )
}
...
//   //     socketService.on(SOCKET_EVENT_CAR_ADDED, car => {
//   //         dispatch(getActionAddCar(car))
//   //     })

//   //     socketService.on(SOCKET_EVENT_CAR_UPDATED, car => {
//   //         dispatch(getActionUpdateCar(car))
//   //     })

//   //     socketService.on(SOCKET_EVENT_CAR_REMOVED, carId => {
//   //         dispatch(getActionRemoveCar(carId))
//   //     })

//   //     return () => {
//   //         socketService.off(SOCKET_EVENT_CAR_ADDED)
//   //         socketService.off(SOCKET_EVENT_CAR_UPDATED)
//   //         socketService.off(SOCKET_EVENT_CAR_REMOVED)
//   //     }
//   // }, [])
